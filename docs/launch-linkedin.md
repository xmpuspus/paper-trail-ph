...
The DPWH flood-control scandal has been reported firm by firm. I wanted to see the whole board at once, so I built it.

Paper Trail PH is an interactive graph of every flood-control contract on the DPWH public record: 33,866 projects worth ₱1.586 trillion, the 6,558 firms that won them, and the license revocations, blacklists, and court filings now attached to some of them.
...
First comment: https://paper-trail-ph.vercel.app

Numbers to reconcile against the site before posting:
- flood-control contracts: 33,866
- flood-control value: ₱1.586T
- distinct firms: 6,558
- concentrated district offices (HHI > 2500): 20
- Sunwest recorded flood-control value: ₱32.83B
- Topnotch: 285 contracts / ₱17.41B

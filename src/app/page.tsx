          ...
          <div className="mt-16 md:mt-24">
            <div className="mb-6">
              ...
              <p className="mt-2 max-w-2xl text-sm text-text-secondary">
                Search any of {stats.totals.contractors.toLocaleString()} firms or {stats.totals.district_offices} district offices.
                Select a node to see its record, its recorded joint ventures, the official actions on file, and the sources.
              </p>
            </div>
